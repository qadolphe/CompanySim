...
class TestAutomakerFinancials:
    ...
    def env(self) -> PolicySnapshot:
        return PolicySnapshot(
            ...
            emissions_penalty_per_unit=500, cafe_ev_mandate_pct=0.1, charging_infrastructure_index=0.1,
        )
    ...
    def test_emissions_penalty_applied(
        ...
        sales = {
            "ICE": SalesRecord("ICE", "ICE", 100, 3_200_000),
    ...
    def test_no_penalty_when_rate_is_zero(
        ...
        sales = {"ICE": SalesRecord("ICE", "ICE", 500, 16_000_000)}
