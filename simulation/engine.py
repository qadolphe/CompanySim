...
class SimulationEngine:
    ...
    def __init__(
        ...
        # Startup gets 20% of legacy capital and constrained launch EV capacity.
    ...
    def _tick(self) -> None:
        ...
        macro_state = {
            ...
            "interest_rate": env_snapshot.interest_rate,
            "electricity_price_per_kwh": env_snapshot.electricity_price_per_kwh,
            "ira_manufacturer_credit_per_kwh": env_snapshot.ira_manufacturer_credit_per_kwh,
            # ── Legacy Automaker ──
            ...
            "legacy_ev_unit_cost": legacy_state.get("ev_unit_cost", 0),
            "legacy_unit_costs": legacy_state.get("unit_costs", {}),
            ...
            "startup_ev_unit_cost": startup_state.get("ev_unit_cost", 0),
